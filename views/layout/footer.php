    ...
    <div class="row gap-2">
        ...
        <div class="col-sm order-sm-2">
            ...
            <div class="links d-flex gap-2 flex-wrap">
                <a href="./index.php?page=home" class="link text-white">Home</a>
                <a href="./index.php?page=majors" class="link text-white">Majors</a>
                <a href="./index.php?page=doctors" class="link text-white">Doctors</a>
...
<script src="views/assets/scripts/home.js"></script>
</body>
